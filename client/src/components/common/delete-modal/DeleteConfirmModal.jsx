...
export default function DeleteConfirmModal({ showModal, toggleModal, deleteHandler }) {
    return (
        <div className={`modal ${showModal ? 'fade show d-block' : ''}`} tabIndex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden={!showModal}>
