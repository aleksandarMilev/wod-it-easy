namespace WodItEasy.Workouts.Application.Features.Participations.Commands.ReJoin
{
    ...
    public class ReJoinParticipationCommand
        : ParticipationCommand<ReJoinParticipationCommand>,
          IRequest<Result<ParticipationOutputModel>>
    {
